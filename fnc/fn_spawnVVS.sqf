...
_vehicle addItemCargoGlobal ["rhs_mag_30Rnd_556x45_Mk262_Stanag", 10];
_vehicle addItemCargoGlobal ["rhsusf_100Rnd_762x51_m993", 5];
_vehicle addItemCargoGlobal ["3Rnd_HE_Grenade_shell", 5];
_vehicle addItemCargoGlobal ["HandGrenade", 10];
_vehicle addItemCargoGlobal ["SmokeShell", 10];
_vehicle addItemCargoGlobal ["Titan_AT", 5];
